...
module complexQueue_OnetoN(	// src/main/scala/snax/xdma/commonCells/commonCells.scala:142:7
  input         clock,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:142:7
                reset,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:142:7
  output        io_in_ready,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  input         io_in_valid,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  input  [31:0] io_in_bits_0,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
                io_in_bits_1,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
                io_in_bits_2,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
                io_in_bits_3,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  input         io_out_0_ready,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  output        io_out_0_valid,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  output [31:0] io_out_0_bits,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  input         io_out_1_ready,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  output        io_out_1_valid,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  output [31:0] io_out_1_bits,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  input         io_out_2_ready,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  output        io_out_2_valid,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  output [31:0] io_out_2_bits,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  input         io_out_3_ready,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  output        io_out_3_valid,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  output [31:0] io_out_3_bits,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
  output        io_allEmpty,	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
                io_anyFull	// src/main/scala/snax/xdma/commonCells/commonCells.scala:149:16
);

  wire _queues_3_io_enq_ready;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:157:15
  wire _queues_3_io_deq_valid;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:157:15
  wire _queues_2_io_enq_ready;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:157:15
  wire _queues_2_io_deq_valid;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:157:15
  wire _queues_1_io_enq_ready;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:157:15
  wire _queues_1_io_deq_valid;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:157:15
  wire _queues_0_io_enq_ready;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:157:15
  wire _queues_0_io_deq_valid;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:157:15
  wire io_in_ready_0 =
    _queues_0_io_enq_ready & _queues_1_io_enq_ready & _queues_2_io_enq_ready
    & _queues_3_io_enq_ready;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:157:15, :162:61
  wire enqueue_valid = io_in_valid & io_in_ready_0;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:162:61, :163:37
  Queue16_UInt32 queues_0 (	// src/main/scala/snax/xdma/commonCells/commonCells.scala:157:15
    .clock        (clock),
    .reset        (reset),
    .io_enq_ready (_queues_0_io_enq_ready),
    .io_enq_valid (enqueue_valid),	// src/main/scala/snax/xdma/commonCells/commonCells.scala:163:37
    .io_enq_bits  (io_in_bits_0),
    .io_deq_ready (io_out_0_ready),
    .io_deq_valid (_queues_0_io_deq_valid),
    .io_deq_bits  (io_out_0_bits)
  );
  Queue16_UInt32 queues_1 (	// src/main/scala/snax/xdma/commonCells/commonCells.scala:157:15
    .clock        (clock),
    .reset        (reset),
    .io_enq_ready (_queues_1_io_enq_ready),
    .io_enq_valid (enqueue_valid),	// src/main/scala/snax/xdma/commonCells/commonCells.scala:163:37
    .io_enq_bits  (io_in_bits_1),
    .io_deq_ready (io_out_1_ready),
    .io_deq_valid (_queues_1_io_deq_valid),
    .io_deq_bits  (io_out_1_bits)
  );
  Queue16_UInt32 queues_2 (	// src/main/scala/snax/xdma/commonCells/commonCells.scala:157:15
    .clock        (clock),
    .reset        (reset),
    .io_enq_ready (_queues_2_io_enq_ready),
    .io_enq_valid (enqueue_valid),	// src/main/scala/snax/xdma/commonCells/commonCells.scala:163:37
    .io_enq_bits  (io_in_bits_2),
    .io_deq_ready (io_out_2_ready),
    .io_deq_valid (_queues_2_io_deq_valid),
    .io_deq_bits  (io_out_2_bits)
  );
  Queue16_UInt32 queues_3 (	// src/main/scala/snax/xdma/commonCells/commonCells.scala:157:15
    .clock        (clock),
    .reset        (reset),
    .io_enq_ready (_queues_3_io_enq_ready),
    .io_enq_valid (enqueue_valid),	// src/main/scala/snax/xdma/commonCells/commonCells.scala:163:37
    .io_enq_bits  (io_in_bits_3),
    .io_deq_ready (io_out_3_ready),
    .io_deq_valid (_queues_3_io_deq_valid),
    .io_deq_bits  (io_out_3_bits)
  );
  assign io_in_ready = io_in_ready_0;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:142:7, :162:61
  assign io_out_0_valid = _queues_0_io_deq_valid;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:142:7, :157:15
  assign io_out_1_valid = _queues_1_io_deq_valid;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:142:7, :157:15
  assign io_out_2_valid = _queues_2_io_deq_valid;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:142:7, :157:15
  assign io_out_3_valid = _queues_3_io_deq_valid;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:142:7, :157:15
  assign io_allEmpty =
    ~_queues_0_io_deq_valid & ~_queues_1_io_deq_valid & ~_queues_2_io_deq_valid
    & ~_queues_3_io_deq_valid;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:142:7, :157:15, :167:{40,72}
  assign io_anyFull =
    ~_queues_0_io_enq_ready | ~_queues_1_io_enq_ready | ~_queues_2_io_enq_ready
    | ~_queues_3_io_enq_ready;	// src/main/scala/snax/xdma/commonCells/commonCells.scala:142:7, :157:15, :170:{39,71}
endmodule
