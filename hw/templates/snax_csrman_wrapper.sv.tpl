...
module ${cfg["tag_name"]}_csrman_wrapper #(
  ...
  ${cfg["tag_name"]}CsrManager i_${cfg["tag_name"]}CsrManager (
    ...
    //-----------------------------
    // Request ports
    .io_csr_config_in_req_bits_data   ( csr_req_bits_data_i  ),
    .io_csr_config_in_req_bits_addr   ( csr_req_bits_addr_i  ),
    .io_csr_config_in_req_bits_write  ( csr_req_bits_write_i ),
    .io_csr_config_in_req_valid       ( csr_req_valid_i      ),
    .io_csr_config_in_req_ready       ( csr_req_ready_o      ),

    // Response ports
    .io_csr_config_in_rsp_bits_data   ( csr_rsp_bits_data_o  ),
